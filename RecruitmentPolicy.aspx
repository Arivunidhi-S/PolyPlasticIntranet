<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RecruitmentPolicy.aspx.cs" Inherits="RecruitmentPolicy" %>
        ...
        <div id="subheader">
            <div class="row">
                <div class="twelve columns">
                    ...
                    <p class="right">
                       PAP Recruitment Policy 11-2015
                    </p>
                </div>
            </div>
        </div>
...
================================================== -->
        <div class="row">
            <div class="twelve columns">
                <%--<iframe src="http://docs.google.com/gview?url=http://www.serbaitproducts.com/PolyPlasticIntranet/PAP Recruitment.pdf&embedded=true" width="800px" height="800px"  frameborder="0"></iframe>--%>
                <%--<iframe src="http://docs.google.com/gview?url=http://localhost/PolyPlasticIntranet/Configure.pdf&embedded=true" width="800px" height="800px"  frameborder="0"></iframe>--%>
                <iframe src="C:/Users/admin/Downloads/Implementation_of_Improved_Billing_System.pdf#toolbar=0" width="800px" height="800px"  frameborder="0"></iframe>
            </div>
        </div>
        <div class="hr">
        </div>
